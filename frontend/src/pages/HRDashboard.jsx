...
function HRDashboard() {
  ...
  return <main className="hr-dashboard">
    ...
    {activeTab === "employees" && <section className="dashboard-section"><h2>{employeeEditingId ? "Edit Employee" : "Add Employee"}</h2><form className="admin-form" onSubmit={submitEmployee}>
